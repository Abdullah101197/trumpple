            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <a class="site-logo" href="<?php echo base_url() ?>">
                        <img class="img-fluid" width="20%" src="<?php echo base_url($settings->logo) ?>" alt="demo" />
                    </a>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 text-left" data-aos="fade-right">
                    ...
                    <form id="register_form" class="authorizationform authorizationform--shadow leave_con" method="post" action="<?php echo base_url('register_user'); ?>" >
                        ...
                        <div class="form-group">
                            <input class="form-control-register" type="text" name="name" placeholder="<?php echo trans('full-name') ?>" required />
                        </div>

                        <div class="form-group">
                            <input class="form-control-register" type="email" name="email" placeholder="<?php echo trans('email') ?>" required />
                        </div>

                        <div class="form-group">
                            <input class="form-control-register" type="password" name="password" placeholder="<?php echo trans('password') ?>" required />
                        </div>
                        ...
                        <div class="text-center">
                            <button style='background:#541554;border-color:#541554' class="btn btn-primary btn-block submit_btn mb-4 loader_btn" type="submit" disabled="disabled"><?php echo trans('get-started') ?> </button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 text-left" data-aos="fade-down">
                        ...
                        <form id="business_form" class="authorizationform authorizationform--shadow leave_con" method="post" action="<?php echo base_url('create-business'); ?>">
                            ...
                            <div class="form-group">
                                <input class="form-control-register" type="text" name="name" placeholder="Business Name" />
                            </div>
                            ...
                            <button style="background:#541554; border-color:#541554" class="btn btn-primary btn-block loader_btn2" type="submit" role="button"><?php echo trans('create') ?></button>
                        </form>
                    </div>
                </div>
            </div>
