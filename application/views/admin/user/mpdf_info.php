                        ...
                        <div class="col-md-12 text-center">
                            <div class="alert alert-warning mt-300">
                                <div class="col-md-12 text-center">
                                    ...
                                    <p>
                                        <b>Download mpdf.zip file here: <a href="http://mbboks.mone.ae/dl/mpdf.zip" class="label label-info"><i class="fa fa-cloud-download"></i> Download Library</a> and upload this zip file in your <strong>project root folder > application > “third_party” </strong> inside this folder and extract it.</b>
                                    </p><br>
                                </div>
                            </div>
