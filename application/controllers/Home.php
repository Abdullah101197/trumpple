...
class Home extends Home_Controller {
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('about-us', $data, TRUE);
        $this->load->view('index', $data);
    }
...
// pricing
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('accounting', $data, TRUE);
        $this->load->view('index', $data);
    }
    ...
    {   
        ...
        $data['settings'] = $this->common_model->get('settings');
        $data['main_content'] = $this->load->view('sales', $data, TRUE);
        $this->load->view('index', $data);
    }
    // book-keeping page
    public function book_keeping()
    {   
        $data = array();
        $data['page_title'] = 'book_keeping';
        $data['settings'] = $this->common_model->get('settings');
        $data['main_content'] = $this->load->view('book_keeping', $data, TRUE);
        $this->load->view('index', $data);
    }
    // invocie-customization page
    public function invocie_customization()
    {   
        $data = array();
        $data['page_title'] = 'invocie-customization';
        $data['settings'] = $this->common_model->get('settings');
        $data['main_content'] = $this->load->view('invocie-customization', $data, TRUE);
        $this->load->view('index', $data);
    }
    // estimate page
    ...
    {   
        ...
        $data['settings'] = $this->common_model->get('settings');
        $data['main_content'] = $this->load->view('estimate', $data, TRUE);
        $this->load->view('index', $data);
    }
    // estimate page
    ...
    {   
        ...
        $data['settings'] = $this->common_model->get('settings');
        $data['main_content'] = $this->load->view('payment-setting', $data, TRUE);
        $this->load->view('index', $data);
    }
    // front-purchase page
    public function front_purchase()
    {   
        $data = array();
        $data['page_title'] = 'front-purchase';
        $data['settings'] = $this->common_model->get('settings');
        $data['main_content'] = $this->load->view('front-purchase', $data, TRUE);
        $this->load->view('index', $data);
    }
    // career page
 ...
 //purchase page
    ...
    {   
        ...
        $data['page_title'] = 'career';
        $data['settings'] = $this->common_model->get('settings');
        $data['main_content'] = $this->load->view('Meeting-our-team', $data, TRUE);
        $this->load->view('index', $data);
    }
